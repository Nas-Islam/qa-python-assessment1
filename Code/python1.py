...
def two(input):
	if input.lower().count('bert') == 2:
		bert1 = input.lower().index('bert')
		bert2 = input.lower().index('bert', bert1+4)
		return input[bert1+4:bert2]
	else:
		return ""
...
def three(arg1):
	word = ""
	if arg1 % 3 == 0 and not arg1 % 5 == 0:
		word = "fizz"
	elif arg1 % 5 == 0 and not arg1 % 3 == 0:
		word = "buzz"
...
def four(arg1):
    ...
    sum = 0
    highestsum = 0
    for i in range(0,len(arg1_list)):
        if arg1_list[i] != " ":
            sum += int(arg1_list[i])
        elif arg1_list[i] == " ":
            sum = 0
...
def seven(input):
	a = input.lower().count("a")
	e = input.lower().count("e")
	i = input.lower().count("i")
	o = input.lower().count("o")
	u = input.lower().count("u")
